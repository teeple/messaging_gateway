...
// REST Server URL
$request_url = 'http://192.168.1.156/note/privatemsg/send_by_phoneno';

$phone_no = array();
$phone_no[] = '01087259388';

// prameters - offset, limit, recipient_phoneno, sender_phoneno
$parameters = array(
    'sender_phoneno' => '01011112222',
    'recipient_phoneno_list' => $phone_no,
    'body' => 'this is message from remote',
    'subject' => 'message from remote'
);
